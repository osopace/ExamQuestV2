...
export default function ProfilePage() {
  const [form, setForm] = useState({
    ...
    school: "unilag",
    examType: "university",
    bio: "Computer Science student. Preparing for semester exams.",
  });
  ...
  const STATS = [
    ...
    { icon: BookOpen, label: "Quizzes", value: "30", color: "text-primary-600", bg: "bg-primary-50" },
    { icon: Trophy, label: "Best Score", value: "93%", color: "text-amber-600", bg: "bg-amber-50" },
    { icon: Target, label: "Avg Score", value: "74%", color: "text-green-600", bg: "bg-green-50" },
  ];
      ...
      <div className="p-6 max-w-3xl mx-auto space-y-6">
        ...
        <Card padding="md">
          ...
          <div className="space-y-4">
            ...
            <Input label="Email Address" type="email" value={form.email} onChange={set("email")} hint="Changing your email requires re-verification." />
            ...
            <div>
              ...
              <textarea
                ...
                value={form.bio}
                onChange={set("bio")}
                className="w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-100 resize-none"
              />
            </div>
